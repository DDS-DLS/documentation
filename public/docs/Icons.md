...
<script>var copyMe = function(myText) {var copyFrom = document.createElement('textarea');copyFrom.textContent = '\\' + myText;var body = document.getElementsByTagName('body')[0];body.appendChild(copyFrom);copyFrom.select();document.execCommand('copy');body.removeChild(copyFrom);}</script><div class="div-library-icon-grid"><div class="dds__icons 
                ...
                "> </div><div class="txt-icon-library-grid">
                  dds__audio-speaker-off
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('e924')">\e924</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                ...
                "> </div><div class="txt-icon-library-grid">
                  dds__chevron-down
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('fe40')">\fe40</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__chevron-left
                "> </div><div class="txt-icon-library-grid">
                  dds__chevron-left
                ...
                "> </div><div class="txt-icon-library-grid">
                  dds__dashboard
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f5e0')">\1f5e0</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__data-center
                "> </div><div class="txt-icon-library-grid">
                  dds__data-center
                ...
                "> </div><div class="txt-icon-library-grid">
                  dds__ellipsis
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('e909')">\e909</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                ...
                "> </div><div class="txt-icon-library-grid">
                  dds__infrastructure
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('e9e0')">\e9e0</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__ink-toner
                "> </div><div class="txt-icon-library-grid">
                  dds__ink-toner
                ...
                "> </div><div class="txt-icon-library-grid">
                  dds__pause
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('23f8')">\23f8</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__pause-sqr
                "> </div><div class="txt-icon-library-grid">
                  dds__pause-sqr
                ...
                "> </div><div class="txt-icon-library-grid">
                  dds__redo
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('2b8e')">\2b8e</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__redo-move
                "> </div><div class="txt-icon-library-grid">
                  dds__redo-move
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('27f3')">\27f3</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__refresh-spin
                "> </div><div class="txt-icon-library-grid">
                  dds__refresh-spin
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f5d8')">\1f5d8</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__removable-storage-usb
                "> </div><div class="txt-icon-library-grid">
                  dds__removable-storage-usb
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea3b')">\ea3b</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__remove-cir
                "> </div><div class="txt-icon-library-grid">
                  dds__remove-cir
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('229d')">\229d</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__remove-sqr
                "> </div><div class="txt-icon-library-grid">
                  dds__remove-sqr
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('229f')">\229f</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__reset
                "> </div><div class="txt-icon-library-grid">
                  dds__reset
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('27f2')">\27f2</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__restore
                "> </div><div class="txt-icon-library-grid">
                  dds__restore
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('2b79')">\2b79</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__rss
                "> </div><div class="txt-icon-library-grid">
                  dds__rss
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea40')">\ea40</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__save
                "> </div><div class="txt-icon-library-grid">
                  dds__save
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('2357')">\2357</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__save-disk
                "> </div><div class="txt-icon-library-grid">
                  dds__save-disk
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f4be')">\1f4be</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__scale
                "> </div><div class="txt-icon-library-grid">
                  dds__scale
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('2912')">\2912</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__search
                "> </div><div class="txt-icon-library-grid">
                  dds__search
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f50d')">\1f50d</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__search-arrow-left
                "> </div><div class="txt-icon-library-grid">
                  dds__search-arrow-left
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f50e')">\1f50e</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__search-arrow-right
                "> </div><div class="txt-icon-library-grid">
                  dds__search-arrow-right
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea46')">\ea46</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__search-back
                "> </div><div class="txt-icon-library-grid">
                  dds__search-back
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('23ee')">\23ee</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__search-forward
                "> </div><div class="txt-icon-library-grid">
                  dds__search-forward
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('23ed')">\23ed</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__server-rack-arrow-right
                "> </div><div class="txt-icon-library-grid">
                  dds__server-rack-arrow-right
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea49')">\ea49</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__server-rack-search
                "> </div><div class="txt-icon-library-grid">
                  dds__server-rack-search
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea4a')">\ea4a</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__server-rack-support
                "> </div><div class="txt-icon-library-grid">
                  dds__server-rack-support
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea4b')">\ea4b</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__share
                "> </div><div class="txt-icon-library-grid">
                  dds__share
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('21b7')">\21b7</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__shield
                "> </div><div class="txt-icon-library-grid">
                  dds__shield
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('26c9')">\26c9</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__shield-check
                "> </div><div class="txt-icon-library-grid">
                  dds__shield-check
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('26ca')">\26ca</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__shield-protect
                "> </div><div class="txt-icon-library-grid">
                  dds__shield-protect
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea4f')">\ea4f</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__shipping
                "> </div><div class="txt-icon-library-grid">
                  dds__shipping
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea50')">\ea50</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__skip-forward
                "> </div><div class="txt-icon-library-grid">
                  dds__skip-forward
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea51')">\ea51</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__skip-to-end
                "> </div><div class="txt-icon-library-grid">
                  dds__skip-to-end
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea52')">\ea52</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__skip-to-front
                "> </div><div class="txt-icon-library-grid">
                  dds__skip-to-front
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea53')">\ea53</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__slider-horiz
                "> </div><div class="txt-icon-library-grid">
                  dds__slider-horiz
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea54')">\ea54</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__slider-vert
                "> </div><div class="txt-icon-library-grid">
                  dds__slider-vert
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f39a')">\1f39a</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__smart-select
                "> </div><div class="txt-icon-library-grid">
                  dds__smart-select
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea56')">\ea56</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__snapshot
                "> </div><div class="txt-icon-library-grid">
                  dds__snapshot
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('2bd0')">\2bd0</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__snowflake
                "> </div><div class="txt-icon-library-grid">
                  dds__snowflake
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('2744')">\2744</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__social-networking
                "> </div><div class="txt-icon-library-grid">
                  dds__social-networking
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea59')">\ea59</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__sort-az
                "> </div><div class="txt-icon-library-grid">
                  dds__sort-az
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('e908')">\e908</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__sort-horiz
                "> </div><div class="txt-icon-library-grid">
                  dds__sort-horiz
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('2b82')">\2b82</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__sort-vert
                "> </div><div class="txt-icon-library-grid">
                  dds__sort-vert
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('296e')">\296e</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__sort-za
                "> </div><div class="txt-icon-library-grid">
                  dds__sort-za
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea5d')">\ea5d</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__speaker-double
                "> </div><div class="txt-icon-library-grid">
                  dds__speaker-double
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea5e')">\ea5e</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__stack
                "> </div><div class="txt-icon-library-grid">
                  dds__stack
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea5f')">\ea5f</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__star
                "> </div><div class="txt-icon-library-grid">
                  dds__star
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('2729')">\2729</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__start-up
                "> </div><div class="txt-icon-library-grid">
                  dds__start-up
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea61')">\ea61</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__stop
                "> </div><div class="txt-icon-library-grid">
                  dds__stop
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('23f9')">\23f9</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__suspend
                "> </div><div class="txt-icon-library-grid">
                  dds__suspend
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea63')">\ea63</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__sync-horiz
                "> </div><div class="txt-icon-library-grid">
                  dds__sync-horiz
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('2b94')">\2b94</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__sync-vert
                "> </div><div class="txt-icon-library-grid">
                  dds__sync-vert
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea65')">\ea65</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__tag
                "> </div><div class="txt-icon-library-grid">
                  dds__tag
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f3f7')">\1f3f7</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__tag-deal
                "> </div><div class="txt-icon-library-grid">
                  dds__tag-deal
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('e90b')">\e90b</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__task-check
                "> </div><div class="txt-icon-library-grid">
                  dds__task-check
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea68')">\ea68</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__task-check-progress
                "> </div><div class="txt-icon-library-grid">
                  dds__task-check-progress
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea69')">\ea69</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__thumb-down
                "> </div><div class="txt-icon-library-grid">
                  dds__thumb-down
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f44e')">\1f44e</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__thumb-up
                "> </div><div class="txt-icon-library-grid">
                  dds__thumb-up
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f44d')">\1f44d</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__toolbox
                "> </div><div class="txt-icon-library-grid">
                  dds__toolbox
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea6c')">\ea6c</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__touch-pad
                "> </div><div class="txt-icon-library-grid">
                  dds__touch-pad
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea6d')">\ea6d</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__trash
                "> </div><div class="txt-icon-library-grid">
                  dds__trash
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f5d1')">\1f5d1</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__tv
                "> </div><div class="txt-icon-library-grid">
                  dds__tv
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f4fa')">\1f4fa</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__undo
                "> </div><div class="txt-icon-library-grid">
                  dds__undo
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('2b8c')">\2b8c</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__undo-move
                "> </div><div class="txt-icon-library-grid">
                  dds__undo-move
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('2b6e')">\2b6e</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__upload
                "> </div><div class="txt-icon-library-grid">
                  dds__upload
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('2b6b')">\2b6b</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__usb
                "> </div><div class="txt-icon-library-grid">
                  dds__usb
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea73')">\ea73</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user
                "> </div><div class="txt-icon-library-grid">
                  dds__user
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f469')">\1f469</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-about
                "> </div><div class="txt-icon-library-grid">
                  dds__user-about
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea75')">\ea75</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-add
                "> </div><div class="txt-icon-library-grid">
                  dds__user-add
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea76')">\ea76</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-check
                "> </div><div class="txt-icon-library-grid">
                  dds__user-check
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea77')">\ea77</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-cir
                "> </div><div class="txt-icon-library-grid">
                  dds__user-cir
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea78')">\ea78</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-cir-add
                "> </div><div class="txt-icon-library-grid">
                  dds__user-cir-add
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea79')">\ea79</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-cir-remove
                "> </div><div class="txt-icon-library-grid">
                  dds__user-cir-remove
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea7a')">\ea7a</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-contact
                "> </div><div class="txt-icon-library-grid">
                  dds__user-contact
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea7b')">\ea7b</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-directory
                "> </div><div class="txt-icon-library-grid">
                  dds__user-directory
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('e90d')">\e90d</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-disable
                "> </div><div class="txt-icon-library-grid">
                  dds__user-disable
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea7d')">\ea7d</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-group
                "> </div><div class="txt-icon-library-grid">
                  dds__user-group
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f46a')">\1f46a</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-group-chat
                "> </div><div class="txt-icon-library-grid">
                  dds__user-group-chat
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea7f')">\ea7f</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-group-disable
                "> </div><div class="txt-icon-library-grid">
                  dds__user-group-disable
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea80')">\ea80</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-groups
                "> </div><div class="txt-icon-library-grid">
                  dds__user-groups
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f46b')">\1f46b</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-groups-disable
                "> </div><div class="txt-icon-library-grid">
                  dds__user-groups-disable
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea82')">\ea82</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-lock
                "> </div><div class="txt-icon-library-grid">
                  dds__user-lock
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea83')">\ea83</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-remove
                "> </div><div class="txt-icon-library-grid">
                  dds__user-remove
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea84')">\ea84</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-search
                "> </div><div class="txt-icon-library-grid">
                  dds__user-search
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea85')">\ea85</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__user-unlock
                "> </div><div class="txt-icon-library-grid">
                  dds__user-unlock
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea86')">\ea86</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__video-card
                "> </div><div class="txt-icon-library-grid">
                  dds__video-card
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea87')">\ea87</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__view-column
                "> </div><div class="txt-icon-library-grid">
                  dds__view-column
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('25a5')">\25a5</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__view-detailed
                "> </div><div class="txt-icon-library-grid">
                  dds__view-detailed
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea89')">\ea89</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__view-grid
                "> </div><div class="txt-icon-library-grid">
                  dds__view-grid
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('25a4')">\25a4</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__view-grid-alt
                "> </div><div class="txt-icon-library-grid">
                  dds__view-grid-alt
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('25a9')">\25a9</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__view-list
                "> </div><div class="txt-icon-library-grid">
                  dds__view-list
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea8c')">\ea8c</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__view-row
                "> </div><div class="txt-icon-library-grid">
                  dds__view-row
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea8d')">\ea8d</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__view-table
                "> </div><div class="txt-icon-library-grid">
                  dds__view-table
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea8e')">\ea8e</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__virtualization
                "> </div><div class="txt-icon-library-grid">
                  dds__virtualization
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea8f')">\ea8f</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__volume
                "> </div><div class="txt-icon-library-grid">
                  dds__volume
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('e911')">\e911</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__warranty
                "> </div><div class="txt-icon-library-grid">
                  dds__warranty
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f5f0')">\1f5f0</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__web-camera
                "> </div><div class="txt-icon-library-grid">
                  dds__web-camera
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea92')">\ea92</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__web-camera-hd
                "> </div><div class="txt-icon-library-grid">
                  dds__web-camera-hd
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea93')">\ea93</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__weight-bell
                "> </div><div class="txt-icon-library-grid">
                  dds__weight-bell
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f514')">\1f514</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__wifi
                "> </div><div class="txt-icon-library-grid">
                  dds__wifi
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f4e1')">\1f4e1</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__wifi-none
                "> </div><div class="txt-icon-library-grid">
                  dds__wifi-none
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('e900')">\e900</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__wifi-simple
                "> </div><div class="txt-icon-library-grid">
                  dds__wifi-simple
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea96')">\ea96</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__windows-support
                "> </div><div class="txt-icon-library-grid">
                  dds__windows-support
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea97')">\ea97</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__wrench-cir
                "> </div><div class="txt-icon-library-grid">
                  dds__wrench-cir
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea98')">\ea98</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__wrench-double
                "> </div><div class="txt-icon-library-grid">
                  dds__wrench-double
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea99')">\ea99</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__wrench-manage
                "> </div><div class="txt-icon-library-grid">
                  dds__wrench-manage
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea9a')">\ea9a</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__wrench-single
                "> </div><div class="txt-icon-library-grid">
                  dds__wrench-single
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f527')">\1f527</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__wrench-tools
                "> </div><div class="txt-icon-library-grid">
                  dds__wrench-tools
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('1f6e0')">\1f6e0</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__zoom-in
                "> </div><div class="txt-icon-library-grid">
                  dds__zoom-in
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea9d')">\ea9d</a></div></div><div class="div-library-icon-grid"><div class="dds__icons 
                  dds__zoom-out
                "> </div><div class="txt-icon-library-grid">
                  dds__zoom-out
                </div><div class="txt-icon-library-grid"><a href="#" onclick="copyMe('ea9e')">\ea9e</a></div></div>
